...
// Login-UserArgumentResolver라는 HandlerMethodArgumetnResolver 인터페이스를 구현한 클래스
...
public class LoginUserArgumentResolver implements HandlerMethodArgumentResolver {
    ...
    @Override
//    supportsParameter : 컨트롤러 메서드의 특정파라미터를 지원하는지 판단
//    여기서는 파라미터에 @LoginUser 어노테이션이 붙어있고, 파라미터 클래스 타입이 SessionUser.class인 경우 true를 반환
    ...
    @Override
//    파라미터에 전달할 객체를 생성 -> 여기서ㅗ는 세션에서 객체를 가져옴.
